/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false ./worker-configuration.d.ts` (hash: ebca1be2876a592e5261ea3b43928094)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AgentSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_VERSION" | "MODEL_ID" | "AI_GATEWAY_ID" | "MODEL_TIMEOUT_MS" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "MODEL_PROVIDER" | "ALLOWED_ORIGINS">> {}
}
